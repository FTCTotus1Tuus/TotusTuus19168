...
public class ControllerModeTest extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        if (tapeSensor.blue() > tapeSensor.red() && tapeSensor.blue() > (tapeSensor.green()/1.2))
            {
                return true;
            } 
             else {
        ...
        public boolean overTapeRed() {
        if (tapeSensor.red() > tapeSensor.blue() && tapeSensor.red() > (tapeSensor.green()/1.2))
            {
                return true;
            } 
             else {
