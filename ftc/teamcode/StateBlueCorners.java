...
@Autonomous(name="StateBlueCorners",group="Linear Opmode") 

public class StateBlueCorners extends DarienOpMode{
    ...
    public void runOpMode() {
        ...
        Rotate(90, 1);
        waitForMotors();
        MoveX(-tileDist-10, autoPower*1.2);
        waitForMotors();
        Rotate(90,0);
        // moveToConeStack();
    ...
    private void dropRedCone() {
        ...
        Rotate(45,1); //turn towards high pole
        waitForMotors();
